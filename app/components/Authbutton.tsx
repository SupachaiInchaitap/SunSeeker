  ...
  return (
    <div className="relative z-30">
      ...
      <details className="dropdown dropdown-bottom dropdown-end group">
        <summary className="w-full py-4 px-6 flex justify-between items-center bg-white text-black border-2 border-red-500 rounded-lg cursor-pointer bg-gray-100">
